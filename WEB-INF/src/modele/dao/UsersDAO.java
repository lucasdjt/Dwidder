        ...
        try (Connection con = ds.getConnection()) {
            ...
            try (Statement stmt = con.createStatement();
                ...
                while (rs.next()) {
                    ...
                    LocalDateTime date_insc = BAO.conversion(rs.getTimestamp("date_insc"));
                    LocalDate date_naiss = BAO.conversion(rs.getDate("date_naiss"));
    ...
    public void insert(User user) {
        try (Connection con = ds.getConnection()) {
            ...
            try (PreparedStatement pstmt = con.prepareStatement(requetePrepare)) {
                ...
                pstmt.setTimestamp(9, BAO.conversion(user.getDate_insc()));
                pstmt.setDate(10, BAO.conversion(user.getDate_naiss()));
    ...
    public void update(User user) {
        try (Connection con = ds.getConnection()) {
            ...
            try (PreparedStatement pstmt = con.prepareStatement(requetePrepare)) {
                ...
                pstmt.setString(7, user.getBio());
                pstmt.setString(8, user.getPdp());
                pstmt.setDate(9, BAO.conversion(user.getDate_naiss()));
